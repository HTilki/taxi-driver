...
`lib_format` est un module Python à utiliser en conjonction avec le module `lib_taxi`.

- Il permet de formater les sorties de `lib_taxi` vers des objets rich.
